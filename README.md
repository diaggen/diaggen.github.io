...
- A horizontal section navigation bar starts below the Paper / arXiv / Code buttons and sticks to the top while scrolling. It highlights the current section and wraps into rows on smaller screens; section links account for the bar's height so headings stay visible. Reduced-motion preferences disable decorative transitions and smooth scrolling, while videos retain visible playback controls.
