...
- A horizontal section navigation bar starts below the Paper / arXiv / Code buttons and sticks flush to the top while scrolling. When sticky, it has rounded lower corners, a pale-green background, a soft shadow and a pill highlight for the current section. Links wrap into rows on smaller screens; section jumps account for the bar's height so headings stay visible. Reduced-motion preferences disable decorative transitions and smooth scrolling, while videos retain visible playback controls.
